...
{
	memcpy(data, mBufferPointer + mLength, sizeof(CHAR));
...
BOOL CStream::ReadCHARs(CHAR *data, INT length)
{
	memcpy(data, mBufferPointer + mLength, length * sizeof(CHAR));

	mLength += length * sizeof(CHAR);
...
{
	memcpy(mBufferPointer + mLength, &data, sizeof(CHAR));
...
BOOL CStream::WriteCHARs(CHAR* data, INT length)
{
	memcpy(mBufferPointer + mLength, data, length * sizeof(CHAR));
